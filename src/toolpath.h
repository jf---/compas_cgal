 ...
 * not link_paths records a link primitive: with clearance_z it is lifted to the
 * clearance plane by a retract/plunge pair, without one it is certified against
 * the walls and raises rather than gouge.
 *
